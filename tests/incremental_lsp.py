...
def main():
    ...
    r = c.recv()
    assert r["result"]["capabilities"]["textDocumentSync"] == 2
    ...
    r = c.recv()
    assert "😀AB" in r["result"][0]["newText"]
    c.close()
    print("incremental UTF-16 LSP PASS")
