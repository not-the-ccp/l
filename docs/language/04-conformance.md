...
`tests/core_conformance.py` is a core-only executable smoke/conformance suite against the included Python reference implementation. It deliberately supplies:
