...
This document describes the current **review snapshot**, extracted from the tested implementation/design work. It is intentionally compact. `language/03-core-semantics.md` contains the less obvious operational rules.
