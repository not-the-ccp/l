...
from lang.analysis_cfg import call_edges,render_calls_dot,render_calls_mermaid,render_cfg_dot,render_cfg_mermaid
...
def parser():
    ...
    try:from lang.cli_common import VERSION
...
def main(argv=None):
    ...
    try:
        ...
        try:
            from lang.cli_common import emit_lang_error;emit_lang_error(e,source.resolve())
